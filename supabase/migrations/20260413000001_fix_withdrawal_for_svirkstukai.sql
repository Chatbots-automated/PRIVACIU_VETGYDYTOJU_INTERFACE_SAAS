-- =====================================================================
-- Fix Withdrawal Calculation for All Treatment-Related Categories
-- =====================================================================
-- Created: 2026-04-13
-- Description:
--   Updates calculate_withdrawal_dates function to include ALL treatment-related
--   product categories: medicines, svirkstukai, treatment_materials, ovules, bolusas
-- =====================================================================
...
BEGIN
    ...
    -- Calculate milk withdrawal (include all treatment-related categories)
    ...
    WITH course_milk AS (
        ...
        WHERE tc.treatment_id = p_treatment_id 
          AND p.category IN ('medicines', 'svirkstukai', 'treatment_materials', 'ovules', 'bolusas')
    ...
    -- Calculate meat withdrawal (include all treatment-related categories)
    -- Include products with 0 days withdrawal (>= 0 instead of > 0)
    WITH course_meat AS (
...
COMMENT ON FUNCTION public.calculate_withdrawal_dates(uuid) IS 'Calculates and updates withdrawal dates for milk and meat based on medications used (includes medicines, svirkstukai, treatment_materials, ovules, and bolusas categories)';
