...
export function SEO({
  ...
  image = 'https://rvac-veterinarija.netlify.app/assets/gvet-logo.png',
  url = 'https://rvac-veterinarija.netlify.app',
  type = 'website'
}: SEOProps) {
  useEffect(() => {
...
export const SEOConfigs = {
  ...
  login: {
    ...
    url: 'https://rvac-veterinarija.netlify.app/login'
  },
  register: {
    ...
    url: 'https://rvac-veterinarija.netlify.app/register'
  },
  vetpraktika: {
    ...
    url: 'https://rvac-veterinarija.netlify.app/vetpraktika'
  },
  veterinarija: {
    ...
    url: 'https://rvac-veterinarija.netlify.app/veterinarija'
  },
  warehouse: {
    ...
    url: 'https://rvac-veterinarija.netlify.app/sandėlis'
  },
  animals: {
    ...
    url: 'https://rvac-veterinarija.netlify.app/gyvūnai'
  },
  reports: {
    ...
    url: 'https://rvac-veterinarija.netlify.app/ataskaitos'
  },
  accounting: {
    ...
    url: 'https://rvac-veterinarija.netlify.app/apskaita'
  }
};
